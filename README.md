# Work-Wibe  
*A modern and responsive Job Portal Website built using HTML, CSS & JavaScript*
...
├── jobs/                # job-listing related files  
...
Please ensure all code changes are clean, well-commented, and aligned with the existing style.

### Installation  
bash
# Clone this repository  
git clone https://github.com/farhanzeb888/Work-Wibe.git  
